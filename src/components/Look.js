...
import Service from '../images/look.jpg'

const Look = () => {
  return (
    <div>
        <div className="untree_co-section2">
                ...
                <div className="row justify-content-between align-items-center">
                    ...
                    <div className="col-lg-6">
                        <figure className="img-play-video">
                            <a id="play-video" className="video-play-button" href="#" data-fancybox>
                                <span></span>
                            </a>
                            <img src={Service} alt="Image" className="img-fluid rounded-20" />
                        </figure>
                    </div>
